...
| voice-interaction | review | cc-fix | 流式文字 + 浏览器语音交互（STT/TTS） | llm, session, server, ChatView, ChatInput, MessageBubble | 0 open findings | cc-archive | 4 findings fixed, Stage1 PASS, Stage2 PASS |
